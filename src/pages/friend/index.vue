<template>
  <div class="container">
    <div class="box">
      ...
      <div class="addractv">
        <div class="addr-box"><text>地区</text><text>{{userCity}}</text></div>
      ...
      <div class="videorz" @tap="showPromp">
        <div class="fdwy-left">
          <p>Ta的视频认证</p>
      ...
      <div class="bottom-box">
        <p @tap="showPromp">聊天、查看视频请下载我约APP</p>
      </div>
    </div>
    <Isreg/>
...
export default{
  components: { Isreg:Isreg, Wyprompt:Wyprompt },
  template: '<Isreg/> <Wyprompt/>',
  data () {
    return {
      msg: '好友资料',
      sexIoc: sexIoc,
